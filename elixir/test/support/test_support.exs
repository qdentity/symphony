defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    ...
    tracker_state_source = Keyword.get(config, :tracker_state_source)
    ...
    sections =
      [
        ...
        tracker_state_source && "  state_source: #{yaml_value(tracker_state_source)}",
        tracker_project_number && "  project_number: #{yaml_value(tracker_project_number)}",
        tracker_project_status_field && "  project_status_field: #{yaml_value(tracker_project_status_field)}",
        "polling:",
